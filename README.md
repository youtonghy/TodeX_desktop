...
- **Desktop 3-Pane Interface**:
  ...
  - **Center Chat Panel**: Full conversation timeline with streaming Markdown rendering, Shiki syntax highlighting, KaTeX math formulas, interactive approval cards (commands, file diffs, tool calls), and prompt input with `@` file mention, `/` slash commands, and `#` skill/MCP suggestions.
