...
const zhCN = {
  ...
  'main.chooseApplication': '选择用于打开的应用',
  'main.unknown': '未知',
...
const messages: MainMessages = {
  ...
  en: {
    ...
    'main.chooseApplication': 'Choose an application to open with',
  ...
  ja: {
    ...
    'main.chooseApplication': '開くアプリケーションを選択',
    'main.unknown': '不明',
  ...
  ko: {
    ...
    'main.chooseApplication': '열 애플리케이션 선택',
    'main.unknown': '알 수 없음',
